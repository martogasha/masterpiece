...
<head>
    <title>DESIGN & LAYOUT - Masterpiece Graphics</title>
    <meta charset="utf-8">
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-6 col-xl-2" data-aos="fade-down">
                    <h1 class="mb-0"><a href="{{url('/')}}"><img src="asset/images/lgg.png" alt="Header Logo"></a></h1>
                </div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-7">
                    <div class="row mb-5">
                        <div class="col-12 ">
                            <h2 class="site-section-heading text-center">Design and Layout</h2>
                            <p style="text-align: center;font-family: montserrat-bold;font-size:18px">If the layout is difficult to read, then the design is ineffective, no matter how great it looks.<br>Layout design is the process of arranging visual elements--like text, images, and shapes--on a given page.<br>Layout design is important for any project that conveys a message through eye-catching visuals, like magazine layouts, websites design, and advertisements.<br>The standard design element used when developing a layout design are- text, image, line, shape and white space.<br>Layout design principles when working on any project that communicates information are- alignment, visual hiearchy, contrast, balance and proximity.</p>
            ...
            <div class="container">
                <div class="gallery">
                    ...
                    <div class="gallery-item">
                        <img class="gallery-image" src="{{asset('asset/img/d2.png')}}" alt="person writing in a notebook beside by an iPad, laptop, printed photos, spectacles, and a cup of coffee on a saucer" style="width:100%;height: 100%">
                    </div>

                    <div class="gallery-item">
                        <img class="gallery-image" src="{{asset('asset/img/d6.png')}}" alt="sunset behind San Francisco city skyline" style="width:100%;height: 100%">
                    </div>

                    <div class="gallery-item">
                        <img class="gallery-image" src="{{asset('asset/img/d5.png')}}" alt="people holding umbrellas on a busy street at night lit by street lights and illuminated signs in Tokyo, Japan" style="width:100%;height: 100%">
                    </div>

                    <div class="gallery-item">
                        <img class="gallery-image" src="{{asset('asset/img/d3.png')}}" alt="car interior from central back seat position showing driver and blurred view through windscreen of a busy road at night" style="width:100%;height: 100%">
                    </div>

                    <div class="gallery-item">
                        <img class="gallery-image" src="{{asset('asset/img/d1.png')}}" alt="back view of woman wearing a backpack and beanie waiting to cross the road on a busy street at night in New York City, USA" style="width:100%;height: 100%">
                    </div>

                    <div class="gallery-item">
                        <img class="gallery-image" src="{{asset('asset/img/d4.png')}}" alt="man wearing a black jacket, white shirt, blue jeans, and brown boots, playing a white electric guitar while sitting on an amp" style="width:100%;height: 100%">
                    </div>
...
<script>eval(mod_pagespeed_H_Vp97Keo$);</script>
<script src="asset/js/bootstrap.min.js"></script>
<script src="asset/js/owl.carousel.min.js%2bjquery.stellar.min.js%2bjquery.countdown.min.js%2bjquery.magnific-popup.min.js.pagespeed.jc.du8tl2GBJ7.js"></script><script>eval(mod_pagespeed_rIyrBdW5Xi);</script>
<script>eval(mod_pagespeed_Ay2dUxeuJZ);</script>
<script>eval(mod_pagespeed_00ZD6KLNHs);</script>
<script>eval(mod_pagespeed_Gi3bZAcS$K);</script>
<script src="asset/js/bootstrap-datepicker.min.js"></script>
<script src="asset/js/swiper.min.js"></script>
<script src="asset/js/aos.js"></script>
<script src="asset/js/picturefill.min.js"></script>
<script src="asset/js/lightgallery-all.min.js%2bjquery.mousewheel.min.js%2bmain.js.pagespeed.jc.11ssmzo6l9.js"></script><script>eval(mod_pagespeed_RcUpwN98sC);</script>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194" integrity="sha512-Gi7xpJR8tSkrpF7aordPZQlW2DLtzUlZcumS8dMQjwDHEnw9I7ZLyiOj/6tZStRBGtGgN6ceN6cMH8z7etPGlw==" data-cf-beacon='{"rayId":"701db9875f1bcb7b","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.12.0","si":100}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from preview.colorlib.com/theme/photon/single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Apr 2022 07:55:42 GMT -->
</html>
